<div>
    ...
    {{--    @endif--}}
        ...
        @else
            <label class="mb-2">
                <a href="{{route('Add_GroupServices')}}" class="btn btn-primary" role="button" aria-pressed="true">عرض الكل</a>
            </label>
            ...
            <form wire:submit.prevent="saveGroup" autocomplete="off">
                ...
                <div class="form-group">
                    <label>{{ trans('Dashboard/GroupServices_trans.notes') }}</label>
                    ...
                    <div class="card-header">
                        <div class="col-md-12">
                            <button class="btn btn-outline-primary"
                                    wire:click.prevent="addService">{{ trans('Dashboard/GroupServices_trans.add_singel_service') }}
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr class="table-primary">
                                    <th>{{ trans('Dashboard/GroupServices_trans.service_name') }}</th>
                                    <th width="200">{{ trans('Dashboard/GroupServices_trans.quantity') }}</th>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <select name="GroupsItems[{{$index}}][service_id]"
                                                        ...
                                                        wire:model="GroupsItems.{{$index}}.service_id">
                                                    <option value="">{{ trans('Dashboard/GroupServices_trans.choose_service') }}</option>
                                        ...
                                        <td>
                                            ...
                                            @elseif($groupItem['service_id'])
                                                <button class="btn btn-sm btn-success mr-1"
                                                        ...
                                                        {{ trans('Dashboard/GroupServices_trans.confirm') }}
                                                </button>
                                            @endif
                                            <button class="btn btn-sm btn-danger"
                                                    wire:click.prevent="removeService({{$index}})">{{ trans('Dashboard/GroupServices_trans.delete') }}
                                            </button>
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <div class="col-lg-4  ">
                            <table class="table ">
                                ...
                                <tr>
                                    <td style="color: red">{{ trans('Dashboard/GroupServices_trans.discount_value') }}</td>
                                    <td width="125">
                                ...
                                <tr>
                                    <td style="color: red">{{ trans('Dashboard/GroupServices_trans.total_tax') }}</td>
