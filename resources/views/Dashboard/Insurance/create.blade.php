...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{trans('Dashboard/insurance_trans.insurances')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/insurance_trans.add_insurance')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
