...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('Dashboard/insurance_trans.insurances')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/insurance_trans.edit_insurance')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('Insurance.update','test')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col">
                                <label>{{trans('Dashboard/insurance_trans.status')}}</label>
                                 &nbsp;
                        ...
                        <div class="row">
                            <div class="col">
                                <button class="btn btn-primary">{{trans('Dashboard/insurance_trans.edit')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
