...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1 mb-1" >!مرحبا عمر</h2>
						  <p class="mg-b-0">لوحة التحكم الخاصة بنظام المستشفي</p>
						</div>
					</div>
				...
				<div class="row row-sm">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">التقرير اليومي</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7"> +{{$GrowsDoctors}}</span>
										</span>
									</div>
								</div>
							</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">الارباح اليومية</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">متوسط ربح الاسبوع </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">مبيعات اليوم</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
				...
				<div class="row row-sm">
						...
						<div class="card">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mb-0">عمليات السنة</h4>
					...
					<div class="col-lg-12 col-xl-5">
						<div class="card card-dashboard-map-one">
							<label class="main-content-label">عملائنا</label>
